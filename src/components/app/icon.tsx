const PATHS: Record<string, string> = {
  ...
  eye: "M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7zM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6",
  eyeOff: "M3 3l18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M6.7 6.7C4 8.3 2 12 2 12s3.5 7 10 7c2 0 3.7-.6 5.1-1.5M21.5 15.5C22.6 13.9 22 12 22 12s-3.5-7-10-7c-.7 0-1.3.1-1.9.2",
