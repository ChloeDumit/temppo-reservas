...
import { loginAction, magicLinkAction, type AuthState } from "../actions";
  ...
  return (
    <div className="card px-5 py-6">
      ...
      <button
        ...
        className="w-full text-sm text-accent underline underline-offset-4 hover:text-accent-hover"
      >
        {mode === "password" ? t("magicLink") : t("signIn")}
      </button>
    </div>
  );
}
